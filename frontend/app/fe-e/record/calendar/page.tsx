...
const FALLBACK_HISTORY: HistoryResponse = {
  ...
  month: 8,
  days: [
    { date: "2026-08-03", completedMissionCount: 2, totalMissionCount: 2, completed: true, personalCompleted: true, groupCompleted: false },
    { date: "2026-08-05", completedMissionCount: 2, totalMissionCount: 2, completed: true, personalCompleted: false, groupCompleted: true },
    { date: "2026-08-10", completedMissionCount: 0, totalMissionCount: 3, completed: false, personalCompleted: false, groupCompleted: false },
    { 
      date: "2026-08-12", completedMissionCount: 3, totalMissionCount: 4, completed: false, personalCompleted: true, groupCompleted: true,
      missions: [
  ...
  return (
   <main className="w-full min-h-[100dvh] sm:h-[100dvh] bg-[#F7F8F8] sm:px-4 sm:py-6 flex items-center justify-center sm:overflow-hidden">
     <div className="mx-auto flex w-full min-h-[100dvh] sm:min-h-0 sm:h-[740px] max-w-none sm:max-w-sm flex-col sm:rounded-3xl bg-white sm:shadow-[0_8px_30px_rgba(31,42,37,0.06)] overflow-hidden relative">
       ...
       {/* 상단 헤더 */}
       <div className="flex items-center justify-center relative bg-white pt-6 pb-4 shrink-0 px-6">
       ...
       <div className="flex-1 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] px-6 pt-2 pb-[100px] flex flex-col">
