    ...
    try {
      ...
      switch (id) {
        ...
        case 'privacy':
          ...
          break;
        case 'camera':
          mockContent = 'WELLLOG는 5초 클립 챌린지 인증을 위해 카메라 접근 권한이 필수적으로 필요합니다.\n\n- 이용 목적: 미션 수행 영상 촬영\n- 카메라 권한을 허용하지 않을 경우 챌린지 참여가 불가능합니다.';
          break;
        case 'studydata':
          ...
          break;
        case 'marketing':
          mockContent = 'WELLLOG의 신규 챌린지 오픈, 리워드 이벤트, 제휴 커머스 할인 혜택 등의 마케팅 정보를 푸시 알림, 이메일 등으로 보내드립니다.\n\n동의하지 않으셔도 기본 서비스 이용은 가능합니다.';
          break;
        default:
